...
export default function ProcurementPage() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10">
      <Link
        href="/"
        className="inline-flex items-center gap-1 text-sm text-[color:var(--color-muted-foreground)] hover:text-[color:var(--color-foreground)] mb-6"
      >
      ...
      <div className="mt-6 flex flex-col gap-4">
        <label className="text-sm">
          ...
          <input
            className="mt-1 w-full rounded-md border border-[color:var(--color-border)] px-3 py-2 text-sm"
            value={form.subject}
        ...
        <label className="text-sm">
          ...
          <textarea
            rows={5}
            className="mt-1 w-full rounded-md border border-[color:var(--color-border)] px-3 py-2 text-sm font-mono"
            value={form.items}
