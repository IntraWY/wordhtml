...
/** Page/header/footer tokens: {page}, {total}, {page_th}, {total_th}, {date}, {date_th}, {date_th_short}, {date_en}, {time}, {time_th}, {filename} */
export const PAGE_TOKEN_REGEX =
  /\{(page_th|total_th|page|total|date_th_short|date_th|date_en|date|time_th|time|filename)\}/g;
