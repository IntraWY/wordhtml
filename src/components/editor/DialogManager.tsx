...
const CrossRefDialog = dynamic(
  () => import("./CrossRefDialog").then((m) => m.CrossRefDialog),
  { ssr: false, loading: () => <FloatingLoader label="กำลังโหลด อ้างอิง…" /> }
);
const DistributionDialog = dynamic(
