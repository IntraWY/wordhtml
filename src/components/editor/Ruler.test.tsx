...
describe("Ruler", () => {
  describe("horizontal", () => {
    ...
    it("renders hanging indent indicator when indentFirst is negative", () => {
      ...
      // The hanging-indent indicator is a small 6x6 square positioned left of
      // the left-indent marker. Master themes it via color-mix(var(--color-accent)).
      const indicator = Array.from(indicators).find((el) => {
