...
const tips: Tip[] = [
  ...
  {
    title: "วางข้อมูลจาก Google Sheets สำหรับตัวแปร",
    body: "ในโหมด Template คุณสามารถคัดลอกตารางจาก Google Sheets แล้ววางในแผงตัวแปรเพื่อสร้างชุดข้อมูลหลายแถว จากนั้นใช้ Preview เพื่อดูผลลัพธ์ที่แทนที่ตัวแปรด้วยข้อมูลแต่ละแถว",
  },
  {
