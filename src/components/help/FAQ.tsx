...
const items: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "การตั้งค่าตัวทำความสะอาดและโหมดรูปภาพถูกบันทึกใน localStorage ของเบราว์เซอร์ เพื่อให้คืนค่าในการใช้งานครั้งต่อไป เอกสารที่กำลังแก้ไม่ถูกบันทึกถาวร (ตั้งใจออกแบบเพื่อความเป็นส่วนตัว)",
  },
  {
    question: "ประวัติเอกสาร (History) กับ Template ต่างกันอย่างไร?",
    answer:
      "ประวัติ (ปุ่ม ประวัติ บนแถบด้านบน) คือ snapshot สูงสุด 20 รายการ เก็บใน localStorage ของเบราว์เซอร์เครื่องนั้นเท่านั้น — ไม่ซิงก์ข้าม PC หรือ notebook Template (เมนู ไฟล์ → Template) บันทึกชื่อเอกสารที่คุณตั้งเองลง Firebase Firestore เมื่อ deploy มีการตั้งค่า Firebase จึงอาจเห็นรายการเดียวกันข้ามเครื่องได้ แต่ไม่ใช่ประวัติอัตโนมัติจาก Ctrl+S",
  },
  {
